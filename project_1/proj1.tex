...
\usepackage[a4paper, total={18cm, 25cm},left=1.8cm,top=1.8cm]{geometry}
\usepackage{color}
%\renewcommand\footnoterule{\kern -3pt \hrule width 1.4in height 1pt \kern 2.6pt}
...
\begin{quotation}
Čím více \textit{druhů}, \textbf{řezů}, {\tiny velikostí}, {\color{red} barev} písma a~jiných \textsc{efektů} použijeme, tím \texttt{profesionálněji} bude {\Large \fontfamily{pzc}\selectfont dokument} vypadat.
